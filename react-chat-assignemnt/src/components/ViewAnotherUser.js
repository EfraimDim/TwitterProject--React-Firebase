  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.userWrapper}>
        ...
        <div className={styles.textWrapper}>
          ...
          <label className={styles.input}>
            Followers: {viewFollowedStats} Following: {viewdFollowersStats}
          </label>
        </div>
      </div>
      {viewedUserID === authInfo.userID ? (
        ...
        <>
          {followStatus ? (
            <div className={styles.following} onClick={() => unfollowUser(viewedUserID)}>
              Unfollow
            </div>
          ) : (
            <div className={styles.unfollow} onClick={() => followUser(viewedUserID)}>
              Follow
            </div>
          )}
        </>
