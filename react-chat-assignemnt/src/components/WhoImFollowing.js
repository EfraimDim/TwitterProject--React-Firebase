...
function WhoImFollowing({myFollowing}) {
    ...
    const { setViewedUserID, setViewAnotherUser, setUsersTweetList, setViewUsersTweets, setViewUsersUsername } = useContext(AuthContext);
    ...
    return <div >
        <h1 className={styles.header}>Following</h1>  
