          ...
          {location.pathname === "/profile" ? (
            ...
            <>
              <div className={styles.buttonWrapper}>
                {viewUsersTweets ? (
                  <div onClick={returnToFollowers} className={styles.yourListSelected}>
                    Return
                  </div>
                ) : (
                  <>
                    {yourTweetListSelected ? (
                      <Link to="/">
                        <div onClick={viewAllTweets} className={styles.yourListSelected}>
                          All Tweets
                        </div>
                      </Link>
                    ) : (
                      <Link to="/myTweets">
                        <div onClick={viewMyTweets} className={styles.yourListUnselected}>
                          My Tweets
                        </div>
                      </Link>
                    )}
